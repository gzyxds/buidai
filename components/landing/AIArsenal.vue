      ...
      <div class="grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div class="space-y-8">
          ...
          <div class="flex flex-wrap gap-4 pt-4">
            <button class="px-8 py-3.5 rounded-lg bg-indigo-500 text-white font-bold hover:bg-indigo-600 transition-all duration-300 transform hover:-translate-y-0.5 flex items-center gap-2" @click="openQrModal('community')">
             加入社群
            </button>
